    ...
    <h1>Create Imprimefacture</h1>

    <form action="{{ route('imprimefactures.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <button type="submit" class="btn btn-primary">Create Imprimefacture</button>
    </form>
