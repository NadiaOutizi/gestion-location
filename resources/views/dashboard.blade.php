    ...
    <div class="grid grid-cols-12 gap-4">
      ...
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Véhicules Loués</div>
      ...
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500"> Véhicule Hors Services</div>
    ...
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Total Des Contrats </div>
            <div class="font-bold text-lg">1259</div>
          </div>
        </div>
      </div>
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">Réservation</div>
            <div class="font-bold text-lg">230</div>
          </div>
        </div>
      </div>
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">TOTAL DES DÉPENSES</div>
            <div class="font-bold text-lg">190</div>
          </div>
        </div>
      </div>
      <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4">
          ...
          <div class="flex flex-col flex-grow ml-4">
            <div class="text-sm text-gray-500">TOTAL DES RECETTES</div>
