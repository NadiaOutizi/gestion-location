<div class="container">
        ...
        <form action="{{ route('contrats.update', $contrat->id) }}" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="numcontrat" class="form-control" value="{{ old('numcontrat') }}" required>
        </div>

        <div class="form-group">
            <label for="datecontrat">Contract Date:</label>
            <input type="date" name="datecontrat" class="form-control" value="{{ old('datecontrat') }}">
        </div>
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary">Update Contrat</button>
        </form>
</div>