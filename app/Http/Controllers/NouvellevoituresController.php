...
class NouvellevoituresController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('nouvellevoitures.index', compact('voitures'));
    }
    ...
    {
        return view('nouvellevoitures.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('nouvellevoitures.index')->with('success', 'Nouvelle voiture created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('nouvellevoitures.edit', compact('voitures'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $nouvelleVoiture->update([
            ...
            return redirect()->route('nouvellevoitures.index')->with('success', 'Nouvelle voiture updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('nouvellevoitures.index')->with('success', 'Nouvelle voiture deleted successfully');
    }
}
